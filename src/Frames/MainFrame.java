...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        //sets up the menu items to ensure all are enabled and disabled appropriately
        editOptionMenuSetup();
    ...
    private void openFile() {
        ...
        if (featuresTabbedPane.indexOfTab("Finder") == -1) {
            ...
            //adds the new finder to the list of finders
            addFinderInstances(finder);
            String filePath = finder.getFilePath();
            //create a new tab with an instance of the finder
            featuresTabbedPane.add("Finder", finder.getContentPane());
            //updates the edit options menu to appropiately enable and disable options
            editOptionMenuSetup();
            //adds a close button to the tab
            initTabComponent(featuresTabbedPane.getTabCount() - 1);

            //updates the recent history list to ensure the file opened will be the first to appear in the list
    ...
    private void fileCheck() {
        ...
        //reads the recent history file and adds to list 
    ...
    //adds recently opened files to the file containing recently added files
    ...
    //enables and disables options in the report menu item
    ...
    //enables and disables options in the edit menu item
    ...
    private void fileOptionMenuSetup(){
                ...
                if(knownError.isEmpty()){
                    exportKnownErrorsItem.setEnabled(false);
                    exportKnownErrorsItem.setForeground(Color.LIGHT_GRAY);

                } else {
                     exportKnownErrorsItem.setEnabled(true);
